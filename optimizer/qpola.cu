// =========================================================================
// QPOLA カーネルコア v1.0.4 260723 by muooon https://github.com/muooon/QPOLA
// =========================================================================
...
// 汎用宣言 (FP32, FP16, BF16 は従来のまま変更なし)
template <typename T> 
...
__device__ __forceinline__ void qpola_kernel_impl(
    ...
    // Conflict に応じて 1.0 〜 min_factor の間で素直にクランプ
    ...
    float g_hat = g_val / (warp_g_scale + eps);
